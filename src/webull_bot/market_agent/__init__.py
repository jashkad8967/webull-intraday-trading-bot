...
from webull_bot.market_agent.response_parsing import (
...
class MarketResearchAgent:
    ...
    _number = staticmethod(_number)
    _extract_json_object = staticmethod(_extract_json_object)
    _salvage_json_objects = staticmethod(_salvage_json_objects)
    _parse_response = _parse_response
    _normalize_review = _normalize_review
